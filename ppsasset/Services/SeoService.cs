...
namespace PPSAsset.Services
{
    ...
    public class SeoService : ISeoService
    {
        ...
        private SeoMetadata GetHomePageMetadata()
        {
            ...
            {
                Title = "PPS Asset | บ้านเดี่ยว ทาวน์โฮม กรุงเทพ - เดอะ ริคโค้ เรสซิเดนซ์",
                Description = "ค้นหาบ้านเดี่ยว ทาวน์โฮม และบ้านแฝด ในกรุงเทพ จากเดอะ ริคโค้ เรสซิเดนซ์ โครงการที่ดีที่สุดในหทัยราษฎร์ จตุโชติ วงแหวน เรามีโครงการมากมายให้คุณเลือก",
                Keywords = "บ้านเดี่ยว กรุงเทพ, ทาวน์โฮม กรุงเทพ, เดอะ ริคโค้, บ้านใหม่ กรุงเทพ, โครงการบ้าน, ซื้อบ้าน, หทัยราษฎร์, จตุโชติ, วงแหวน",
                OgType = "website",
        ...
        private SeoMetadata GetPropertyTypeMetadata(string thaiType, string englishType)
        {
            return new SeoMetadata
            {
                ...
                Description = $"ค้นหา{thaiType}ใหม่ในกรุงเทพและปริมณฑล จากเดอะ ริคโค้ เรสซิเดนซ์ ราคาดี ติดต่อสอบถามได้ทุกวัน",
